function AudioPlayback() {
    ...
    this.play = function play(audioDataRef, sampleRate, start, end) {
        ...
        // Connect the nodes, play!
        this.gainNode.gain.value = 1;
        this.javaScriptNode.connect(this.gainNode);
    };
    ...
    this.stop = function stop() {
        ...
        this.gainNode.gain.setValueAtTime(0, this.audioContext.currentTime + 0.5);
        setTimeout(() => this.javaScriptNode.disconnect(this.gainNode), 500);
    ...
    // The GainNode is used to remove the clicks at the start and the end
